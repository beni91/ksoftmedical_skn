...

{
    ...
    'depends': ['base', 'account', 'sale', 'account_check_printing', 'base_account_budget','ksoftmedical'],
    'data': [
		...
		'views/account_move_service.xml',
		...
		'report/template_releve_pharmacie_views.xml',
		#'report/rapport_caisse.xml',
        'report/report.xml',
