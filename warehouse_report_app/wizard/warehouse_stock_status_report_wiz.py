...
class StockStatusWarehouseReport(models.TransientModel):
    ...
    def print_stock_valuation_pdf_report(self):
        self.ensure_one()
        [data] = self.read()
        datas = {
             'ids': [1],
        ...
        return self.env.ref('warehouse_report_app.action_report_stock_inventory_status2').report_action(self, data=datas)
    ...
    def print_excel_report(self):
        ...
        if warehouse_ids:
            for warehouse in warehouse_ids:
                # Report Title
                worksheet.merge_range((rowscol + 2), 0, (rowscol + 2), 3,'Entrepot', title_format)
                ...
                worksheet.merge_range((rowscol + 4), 5, (rowscol + 4), 7,'Date debut: ', title_format)
                worksheet.merge_range((rowscol + 5), 5, (rowscol + 5), 7, str(start_date) , title_format)

                worksheet.merge_range((rowscol + 4), 12, (rowscol + 4), 14,'Date fin:', title_format)
                ...
                worksheet.write((rowscol + 7), 1, 'Product', cell_wrap_format_bold)
                worksheet.write((rowscol + 7), 2, 'Categorie', cell_wrap_format_bold)
                worksheet.write((rowscol + 7), 3, 'Emplacement', cell_wrap_format_bold)
                ...
                worksheet.write((rowscol + 8), 4, 'Qty Entrée', cell_wrap_format_bold)
                worksheet.write((rowscol + 8), 5, 'Qty Sortie', cell_wrap_format_bold)
                worksheet.write((rowscol + 8), 6, 'Retour Qty Entrée', cell_wrap_format_bold)
                worksheet.write((rowscol + 8), 7, 'Retour Qty Sortie', cell_wrap_format_bold)
                rows = (rowscol + 9)
            ...
            for location in location_ids:
                ...
                # Report Content
                worksheet.write((rowscol + 7), 0, 'Code', cell_wrap_format_bold)
                worksheet.write((rowscol + 7), 1, 'Produit', cell_wrap_format_bold)
                worksheet.write((rowscol + 7), 2, 'Categorie', cell_wrap_format_bold)
        ...
        buf = base64.b64encode(open(file_path, 'rb+').read())
        self.document = buf
