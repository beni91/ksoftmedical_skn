...
class AccountJournalCode(models.Model):
    ...
    date_ouverture = fields.Datetime(string="Date debut", required="1")
    code = fields.Char(string="Code")
    date_fermeture = fields.Datetime(string="Date de fin", compute='_set_fermeture_date', store=True)
    ...
    def check_validaty_status(self, journal):
        nbre = self.search([('internal_status','in',['cours']),('journal','=',journal)])
        return len(nbre)
