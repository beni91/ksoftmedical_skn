...
class PharmacieStockMove(models.Model):
    _inherit = 'module.ordonnance'
    ...
    def _get_status(self):
        for exam in self:
            ...
            return super(PharmacieStockMove, self)._get_status()
            ...
            if not self.invoice_picking_id:
                ...
                if self.picking_type_id.code == 'outgoing':
                    ...
                    pick = {
                        ...
                        #'location_dest_id': self.client.property_stock_customer.id,
                ...
                if self.picking_type_id.code == 'incoming':
                    pick = {
                        ...
                        #'location_id': self.client.property_stock_supplier.id,
                ...
                moves = order.produit_ids.filtered(
...
class SupplierInvoiceLine(models.Model):
    _inherit = 'module.ordonnance.line'
        ...
        for line in self:
            ...
            if picking.picking_type_id.code == 'outgoing':
                template = {
                    ...
                    #'location_dest_id': line.ordonnace_id.client.property_stock_customer.id,
                    'location_dest_id': line.ordonnace_id.patient_id.partner_id.property_stock_customer.id,
                    'picking_id': picking.id,
                    'state': 'draft',
                    'company_id': line.ordonnace_id.move_id.company_id.id,
                    'price_unit': line.product.list_price,
                    'quantity_done': line.quantity2,
            ...
            if picking.picking_type_id.code == 'incoming':
                template = {
                    ...
                    'product_id': line.product.id,
                    'product_uom': line.product.uom_id.id,
                    'location_id': line.ordonnace_id.patient_id.partner_id.property_stock_supplier.id,
                    #'location_id': line.ordonnace_id.client.property_stock_supplier.id,
